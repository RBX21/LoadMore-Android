...
public class LoadMoreAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private boolean mIsLoadFromStart = false;

    public LoadMoreAdapter(@NonNull RecyclerView.Adapter adapter, boolean mIsLoadFromStart) {
        this.mIsLoadFromStart = mIsLoadFromStart;
